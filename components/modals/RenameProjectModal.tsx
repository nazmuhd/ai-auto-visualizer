...
export const RenameProjectModal: React.FC<Props> = ({ isOpen, onClose, onSave, currentName, currentDescription }) => {
  ...
  return (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 bg-slate-900/40 backdrop-blur-sm duration-200" onClick={onClose}>
      <div role="dialog" aria-modal="true" aria-labelledby="rename-modal-title" className="bg-white rounded-2xl shadow-2xl w-full max-w-md duration-200 relative" onClick={(e) => e.stopPropagation()}>
