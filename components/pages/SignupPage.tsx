...
export const SignupPage: React.FC<Props> = ({ onSignup, onNavigate }) => {
      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl shadow-xl border border-slate-200/80 p-8">
          <div className="text-center mb-6">
            ...
            <p className="text-slate-500 mt-1">Get started for free.</p>
          </div>
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              ...
              <div className="relative mt-1">
                ...
                <input id="name" type="text" value={name} onChange={(e) => setName(e.target.value)} className="w-full pl-10 pr-3 py-2.5 border bg-white text-slate-900 border-slate-300 rounded-lg focus:ring-2 focus:ring-primary-500 outline-none" required />
              </div>
            </div>
            <div>
              ...
              <div className="relative mt-1">
                ...
                <input id="email" type="email" value={email} onChange={(e) => setEmail(e.target.value)} className="w-full pl-10 pr-3 py-2.5 border bg-white text-slate-900 border-slate-300 rounded-lg focus:ring-2 focus:ring-primary-500 outline-none" required />
              </div>
            </div>
            <div>
          ...
          <p className="text-center text-sm text-slate-500 mt-6">
            ...
            <a href="#" onClick={(e) => { e.preventDefault(); onNavigate('login'); }} className="font-medium text-primary-600 hover:text-primary-700">
              Log in
            </a>
          </p>
        </div>
