    ...
    return (
        <div className="h-full flex flex-col bg-white/95 backdrop-blur-xl rounded-2xl shadow-2xl border border-slate-200 overflow-hidden">
            ...
            <div className="flex-1 overflow-y-auto custom-scrollbar p-3">
                {/* Key attribute here forces remount and animation on tab change */}
                <div key={activePanel} className="space-y-4 animate-in slide-in-from-right-4 fade-in duration-300">
                    {activePanel === 'text' && (
                        <>
                            <section>
